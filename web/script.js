const link =
  "http://api.weatherstack.com/current?access_key=6ed6aadcba64697b6666244583282fe7";
...
const markup = () => {
  ...
  return `<div class="container ${containerClass}">
            <div class="top">
              ...
              <div class="top-right">
                <div class="city-info__subtitle">сейчас ${observationTime}</div>
